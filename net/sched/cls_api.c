...
static struct tcf_block *tcf_block_create(struct Qdisc *q)
{
...
int tcf_block_get(struct tcf_block **p_block,
		  ...
		  struct Qdisc *q)
{
	return __tcf_block_get(p_block, false, NULL, 0, p_filter_chain, q);
}
...
int tcf_block_get_shared(struct tcf_block **p_block,
			 ...
			 struct tcf_proto __rcu **p_filter_chain)
{
	return __tcf_block_get(p_block, true, net, block_index,
			       p_filter_chain, NULL);
}
